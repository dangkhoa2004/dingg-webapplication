...
const navItems: NavItem[] = [
  {
    ...
    name: "Conversation",
    subItems: [{ name: "Conversation", path: "/conversation", pro: false }],
  },
  {
    icon: <GridIcon className="size-5" />,
    name: "Dashboard",
...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    // mở submenu tương ứng khi route trùng
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            <div>
              ...
              >
                {isExpanded || isHovered || isMobileOpen ? "Menu" : <HorizontaLDots className="size-5" />}
              </h2>
            ...
            <div>
              ...
              >
                {isExpanded || isHovered || isMobileOpen ? "Others" : <HorizontaLDots className="size-5" />}
              </h2>
